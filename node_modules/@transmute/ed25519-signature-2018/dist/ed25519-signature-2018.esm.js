...
import { constants as constants$1 } from '@transmute/security-context';
import { constants } from '@transmute/credentials-context';
...
var Ed25519VerificationKey2018 = /*#__PURE__*/function (_Ed25519KeyPair) {
  ...
  function Ed25519VerificationKey2018(args) {
    ...
    var JWA_ALG = "EdDSA";
    var verifier = JWS.createVerifier(_this.verifier("EdDsa"), JWA_ALG, {
      detached: true
    });
    ...
    if (_this.privateKey) {
      var signer = JWS.createSigner(_this.signer("EdDsa"), JWA_ALG, {
        detached: true
      });
    ...
    return runtime_1.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return Ed25519KeyPair.from(args);
...
var Ed25519Signature2018 = /*#__PURE__*/function () {
  ...
  _proto.ensureSuiteContext = function ensureSuiteContext(_ref) {
    ...
    if (document["@context"] === constants.CREDENTIALS_CONTEXT_V1_URL || Array.isArray(document["@context"]) && document["@context"].includes(constants.CREDENTIALS_CONTEXT_V1_URL)) {
      // document already includes the required context
      return;
    } // otherwise ensure the suite context


    if (document["@context"] === constants$1.ED25519_2018_v1_URL || Array.isArray(document["@context"]) && document["@context"].includes(constants$1.ED25519_2018_v1_URL)) {
      // document already includes the required context
      return;
    }
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              context = document["@context"] || constants$1.ED25519_2018_v1_URL;
...
export { Ed25519Signature2018, Ed25519VerificationKey2018 };
