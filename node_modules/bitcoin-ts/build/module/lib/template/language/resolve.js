...
import { IdentifierResolutionErrorType, IdentifierResolutionType, } from './language-types';
 ...
 */
export const resolveVariableIdentifier = ({ data, environment, identifier, }) => {
 ...
 */
export const resolveScriptIdentifier = ({ data, environment, identifier, }) => {
 ...
 */
export const createIdentifierResolver = ({ data, environment, }) => 
// eslint-disable-next-line complexity
(identifier) => {
