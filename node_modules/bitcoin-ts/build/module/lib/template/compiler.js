import { generateBytecodeMap, OpcodesCommon, } from '../vm/instruction-sets/instruction-sets';
...
export const createCompiler = (compilationEnvironment) => ({
    ...
    generateBytecode: (scriptId, data, debug = false) => {
        const result = compileScript(scriptId, data, compilationEnvironment);
        return (debug
            ? result
            : result.success
    ...
    generateScenario: ({ unlockingScriptId, scenarioId }) => generateScenarioCommon({
        environment: compilationEnvironment,
        scenarioId,
        unlockingScriptId,
    }),
 ...
 */
export const createCompilerCommonSynchronous = (scriptsAndOverrides) => {
 ...
 */
export const authenticationTemplateToCompilationEnvironment = (template) => {
 ...
 * compilation environment
 */
export const authenticationTemplateToCompilationEnvironmentVirtualizedTests = (template) => {
