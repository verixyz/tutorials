...
export const parseAuthenticationTemplateScripts = (scripts) => {
    ...
    const unlockingResults = allScripts
        ...
        // eslint-disable-next-line complexity
        .map(({ id, script }) => {
        const { ageLock, estimate, fails, name, passes, script: scriptContents, timeLockType, unlocks, } = script;
    ...
    const testedResults = allScripts
        ...
        // eslint-disable-next-line complexity
        .map(({ id, script }) => {
        const { tests, script: scriptContents, name } = script;
        if (typeof scriptContents !== 'string') {
        ...
        // eslint-disable-next-line complexity
        tests.map((test) => {
            const { check, fails, name: testName, passes, setup } = test;
 ...
 * @param scripts - the `scripts` property of an `AuthenticationTemplate`
 */
export const parseAuthenticationTemplateVariable = (variables, entityId) => {
    ...
    const variableResults = allEntities
        ...
        if (type === 'HdKey') {
            ...
            const privatePath = privateDerivationPath ?? CompilerDefaults.hdKeyPrivateDerivationPath;
 ...
 * @param scripts - the `scripts` property of an `AuthenticationTemplate`
 */
export const parseAuthenticationTemplateEntities = (entities) => {
 ...
 */
// eslint-disable-next-line complexity
export const parseAuthenticationTemplateScenarioDataHdKeys = (hdKeys, location) => {
 ...
 * `'lockingBytecode.override' in output 2 of scenario "test"`
 */
export const parseAuthenticationTemplateScenarioDataKeys = (keys, location) => {
 ...
 */
// eslint-disable-next-line complexity
export const parseAuthenticationTemplateScenarioData = (data, location) => {
 ...
 * e.g. `scenario "test"`
 */
export const parseAuthenticationTemplateScenarioTransactionInputs = (inputs, location) => {
    if (inputs === undefined) {
        return undefined;
    }
 ...
 */
// eslint-disable-next-line complexity
export const parseAuthenticationTemplateScenarioTransactionOutputLockingBytecode = (lockingBytecode, location) => {
 ...
 */
export const parseAuthenticationTemplateScenarioTransactionOutputs = (outputs, location) => {
 ...
 */
// eslint-disable-next-line complexity
export const parseAuthenticationTemplateScenarioTransaction = (transaction, location) => {
 ...
 */
export const parseAuthenticationTemplateScenarios = (scenarios) => {
 ...
 */
// eslint-disable-next-line complexity
export const validateAuthenticationTemplate = (maybeTemplate) => {
