...
exports.parseAuthenticationTemplateScripts = (scripts) => {
    ...
    const unlockingResults = allScripts
        ...
        return {
            id,
            script: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (ageLock === undefined ? {} : { ageLock })), (estimate === undefined ? {} : { estimate })), (fails === undefined ? {} : { fails })), (passes === undefined ? {} : { passes })), (name === undefined ? {} : { name })), { script: scriptContents }), (timeLockType === undefined ? {} : { timeLockType })), { unlocks }),
        };
    });
    ...
    const testedResults = allScripts
        ...
        tests.map((test) => {
            ...
            return Object.assign(Object.assign(Object.assign(Object.assign({ check }, (fails === undefined ? {} : { fails })), (passes === undefined ? {} : { passes })), (testName === undefined ? {} : { name: testName })), (setup === undefined ? {} : { setup }));
        });
        ...
        return {
            id,
            script: Object.assign(Object.assign({}, (name === undefined ? {} : { name })), { script: scriptContents, tests: validTests }),
        };
    });
