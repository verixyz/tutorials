import { IKey, KeyMetadata } from '@verixyz/core';
import { VerificationMethod } from 'did-resolver';
/**
 * Broader definition of Verification method that includes the legacy publicKeyBase64
 * @internal
 */
export declare type _ExtendedVerificationMethod = VerificationMethod & {
    publicKeyBase64?: string;
};
/**
 * Represents an {@link @verixyz/core#IKey} that has been augmented with its corresponding
 ...
 * @internal
 */
export declare type _NormalizedVerificationMethod = Omit<VerificationMethod, 'publicKeyBase58' | 'publicKeyBase64' | 'publicKeyJwk'>;
/**
