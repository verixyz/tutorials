import { IAgentContext, IResolver } from '@verixyz/core'
import { AbstractMessageHandler, Message } from '@verixyz/message-handler'
import { verifyJWT, decodeJWT } from 'did-jwt'
import Debug from 'debug'
import { Resolvable } from 'did-resolver'
const debug = Debug('verixyz:did-jwt:message-handler')

export type IContext = IAgentContext<IResolver>

/**
 * A plugin for {@link @verixyz/message-handler#MessageHandler} that finds and verifies a JWT in a message.
 * @public
 */
