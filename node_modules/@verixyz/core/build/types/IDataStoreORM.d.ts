...
/**
 * This context can be used for verixyz Agents that are created behind an authorization mechanism, that attaches a DID
...
/**
 * This is the default query interface for the credential data stored by a verixyz agent.
 *
...
export interface IDataStoreORM extends IPluginMethodMap {
     ...
     * by this agent.
     *
     * If the same database is used for implementations of {@link @verixyz/did-manager#AbstractDIDStore |
