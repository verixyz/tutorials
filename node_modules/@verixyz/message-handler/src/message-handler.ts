...
const debug = Debug('verixyz:message-handler')
...
/**
 * Agent plugin that provides {@link @verixyz/core#IMessageHandler} methods
 */
export class MessageHandler implements IAgentPlugin {
  ...
  /** {@inheritDoc @verixyz/core#IMessageHandler.handleMessage} */
