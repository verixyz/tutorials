...
export const LdDefaultContexts = new Map([
  ...
  ['https://verixyz.io/contexts/socialmedia/v1', _read('socialmedia-v1.jsonld')],
  ['https://verixyz.io/contexts/kyc/v1', _read('kyc-v1.jsonld')],
  ['https://verixyz.io/contexts/profile/v1', _read('profile-v1.jsonld')],
