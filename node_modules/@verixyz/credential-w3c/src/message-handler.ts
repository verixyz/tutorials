import { IAgentContext, IResolver, VerifiableCredential, VerifiablePresentation } from '@verixyz/core'
import { AbstractMessageHandler, Message } from '@verixyz/message-handler'
import { asArray, computeEntryHash, decodeCredentialToObject, extractIssuer } from '@verixyz/utils'
import {
  normalizeCredential,
...
const debug = Debug('verixyz:w3c:message-handler')
